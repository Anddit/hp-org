<template>
  <div id="root" class="bg-gray-100">
    ...
    >
      ...
      <main class="container max-w-5xl flex flex-col w-full">
        <div class="container-wrapper w-full">
          <section class="container-filters w-full">
            <ais-breadcrumb
              :attributes="[
                'hierarch.lvl0',
                'hierarch.lvl1',

              ]" class="md:flex pl-0 py-0 container hidden  text-gray-500">
              <ul slot-scope="{ items, refine, createURL }" class="flex flex-row text-sm">
                  <li>
                    <a :href="createURL()" @click.prevent="refine()" class="pr-2">Search</a>
                  </li>
            ...
            <div class="container-header font-bold text-2xl">
              <h2>Filters</h2>
            ...
            <div class="container-body flex flex-wrap w-full md:w-3/4 justify-between">
              ...
              <ais-panel >
                ...
                <template slot="default" class="flex w-full">
                <!--   <ais-hierarchical-menu
                  ...
                  <ais-hierarchical-menu
                   ...
                   v-bind:class="{ invisible: isActive }"
                 ...
                 <!--    <div  slot-scope="{ 
                  ...
                  <div class="w-full t0 overflow-y-auto text-sm">
                    ...
                    <button
                        ...
                        class="py-3 bg-white border border-gray-400 selectbutton w-full rounded "
                      >
                      <div
                          v-if="!isShowingMore"
                          class="flex flex-row justify-between px-2" >
                          <span class="t4 text-sm text-gray-800">
                              Categories
                          </span>
                          <span class="t2 text-sm text-primary">
                      ...
                      <div
                          v-else
                          class="flex flex-row justify-between px-2">
                          <span class="t4 text-sm text-primary">
                              Close
                          </span>
             ...
             <ais-panel class="w-full md:w-1/3">
                <template slot="header"></template>
                          ...
                          <div class="w-full t0 overflow-y-auto text-sm">
                              <div class="w-full bg-white">
                                  <button
                                      @click="toggleShowMore"
                                      :disabled="!canToggleShowMore"
                                      class="py-3 border border-gray-400 selectbutton w-full rounded ">
                                      <div
                                          v-if="!isShowingMore"
                                          class="flex flex-row justify-between px-2" >
                                          <span class="t4 text-sm text-gray-800">
                                          ...
                                          <a
                                              ...
                                              <div class="w-4/5">
                                                  <ais-highlight
                                                      ...
                                                      class="t0 items-center text-gray-700 text-lg md:text-sm leading-loose"/>
                                              </div>
                                          </a>
                                      </li>
                                      <div
              ...
              <ais-panel class="w-full md:w-1/3">
                ...
                <template slot="default">
                  <!-- <ais-refinement-list
                    attribute="diagnoses"
                    searchable
                    searchablePlaceholder="Search for diagnoses..."
                  /> -->
                                          ...
                                          <a
                                              ...
                                              <div class="w-4/5">
                                                  <ais-highlight
                                                      ...
                                                      :hit="item"
                                                      :style="{ fontWeight: item.isRefined ? 'bold' : '', color: item.isRefined ? '#1062ed' : '#4a5568'}"
                                                      class="t0 items-center leading-loose text-gray-700 text-sm"/>
                                              </div>
                                          </a>
                                      </li>
                                      <div
          ...
          <!--  <ais-panel class="w-full md:w-1/5">
        ...
        <section class="container-results">
          <header class="container-header container-options">
            <ais-sort-by
              ...
              :items="[
                { value: 'production_organizations', label: 'Featured' },
          ...
          <ais-hits  :transformItems="transformItems">
            <div slot="item" slot-scope="{ item }" class="my-4">
              <article class="hit border border-gray-300 rounded-lg overflow-hidden flex w-full justify-between items-center  flex-wrap-reverse bg-white articlerow" >
                

                <div class="w-full md:w-1/2 py-4 px-8 h-full tracking-tight">
                
                  <h1 class="pt-2">
                    <ais-highlight attribute="name" class="text-3xl leading-tight tracking-tight text-blue-900" :hit="item"/>
                
                  </h1>
                  <p v-if="item.location" class="text-sm py-2 text-gray-700">{{ item.location }}</p>
                  <p class="hit-description text-base font-normal text-gray-600  leading-normal">
                  ...
                  <footer>
                   <div class="flex flex-row  w-full items-start px-2">
                     ...
                     <div class="flex flex-row py-3 px-3 w-full items-start">
                         <div
                           v-if="item.known_for"
                         ...
                         >
                           ...
                           <div
                             class="highlightstyle h-full inline text- no-underline leading-tight tracking-tight  t4 text-indigo-600 text-base"
                           >
                             {{ item.known_for | truncate(75) }}
                           </div>
                         </div>
                       </div>
                  </footer>
                </div>
                <header class="w-full md:w-1/2 h-full  items-start object-cover ">
